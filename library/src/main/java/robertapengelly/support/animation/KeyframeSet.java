...
class KeyframeSet {
    ...
    /**
     * Gets the animated value, given the elapsed fraction of the animation (interpolated by the animation's interpolator)
     * and the evaluator used to calculate in-between values. This
    ...
    static KeyframeSet ofKeyframe(Keyframe... keyframes) {
    ...
    static KeyframeSet ofObject(Object... values) {
