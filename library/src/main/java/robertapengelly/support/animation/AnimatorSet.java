...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet clone() {
        ...
        HashMap<Node, Node> nodeCloneMap = new HashMap<>(); // <old, new>
    ...
    public void setTarget(Object target) {
        ...
        for (Node node : mNodes) {
            ...
            if ((animation instanceof AnimatorSet) || (animation instanceof ObjectAnimator))
    ...
    public void start() {
        ...
        for (Node node : mSortedNodes) {
            ...
            if ((oldListeners != null) && (oldListeners.size() > 0)) {
                ...
                final ArrayList<AnimatorListener> clonedListeners = new ArrayList<>(oldListeners);
                
                for (AnimatorListener listener : clonedListeners)
                    if ((listener instanceof AnimatorSetListener) || (listener instanceof DependencyListener))
