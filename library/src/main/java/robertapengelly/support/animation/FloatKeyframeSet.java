 ...
 *
 * <p>This type-specific subclass of KeyframeSet, along with the other type-specific subclass for int, exists to speed up the
...
class FloatKeyframeSet extends KeyframeSet {
    ...
    public FloatKeyframeSet clone() {
        ...
        for (int i = 0; i < numKeyframes; ++i)
            newKeyframes[i] = (FloatKeyframe) mKeyframes.get(i).clone();
